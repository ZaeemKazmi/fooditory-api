...
const sentMessageEmail = (receiverEmail, receiverName, senderName, message) => {
  ...
  var mailTemplate =
    ...
    '    </tbody></table><table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="nP2VTKZg9DBCkZNYMeSi5y">' +
    "      <tbody><tr>" +
    '        <td style="background-color:#fe5d61; padding:30px 50px 30px 50px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="#fe5d61"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 17px">Hey ' + receiverName + ', you just received a message from ' + senderName + '!</span></div>' +
    '<div style="font-family: inherit; text-align: center"><br></div>' +
    '<div style="font-family: inherit; text-align: center"><span style="font-size: 17px">It says:</span></div>' +
    '<div style="font-family: inherit; text-align: center"><span style="font-size: 17px"> </span></div>' +
    '<blockquote style="text-align: center"><span style="color: #ffffff; font-size: 17px; font-family: courier, monospace">' + message + '</span><span style="font-size: 17px">  </span></blockquote>' +
    '<div style="font-family: inherit; text-align: center"><span style="font-size: 17px">Visit your account to reply to him, as he is waiting for your response! </span></div><div></div></div></td>' +
    "      </tr>" +
    '    </tbody></table><table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="f039d645-1ca4-4762-a0cc-562bf1ac4e23">' +
    "    <tbody>" +
    "      <tr>" +
...
messageEmailTemplate = (receiverName, senderName, message) => {
